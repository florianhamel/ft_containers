...
/*   Updated: 2022/01/25 16:20:13 by fhamel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// template <class T>
// class my_input_iter : public std::base_iterator<std::input_iterator_tag, T> {};

// template <class T>
// class my_forward_iter: public std::base_iterator<std::forward_iterator_tag, T> {};
...
// void	printTree(std::Node<Key, T> *current)
// {
...
void	ft_map_speed()
{
	std::vector<std::pair<int, float> >	vec_;
	for (int i = 0; i < 10000; ++i) {
		vec_.push_back(std::make_pair<int, float>(i, 10000 - i));
	}
	std::map<int, float>	mp(vec_.begin(), vec_.end());
