...
/*   Updated: 2022/01/27 23:53:13 by fhamel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_set_empty_size()
{
	...
	ft::set<int>	st;
	ft::set<int>	st_range(vec.begin(), vec.end());
...
void	ft_set_max_size()
{
	...
	ft::set<float>				st1;
	ft::set<foo<std::string> >	st2;
	ft::set<int>				st3;
	ft::set<std::string>		st4;
	ft::set<std::vector<int> >	st5;
...
void	ft_set_bounds()
{
	...
	ft::set<int>	st(vec.begin(), vec.end());
	iterator	it;
	ft::pair<iterator, iterator>	eq_range;
...
void	ft_set_relational_operators()
{
	...
	ft::set<int>	st1(vec.begin(), vec.end());
	ft::set<int>	st2;
